...
public class GameDirector : MonoBehaviour
{
            ...
            case 6:
                {
                    ...
                    if (this.delta1 > 8f)
                    {
                        YellowSuraimuEnergy1(1.4f, 7.0f);
                        i += YellowSuraimuHP1(-1.4f, 7.0f);
                        NullDestroy();
                    } break;
                }
        }
    ...
    int case2()
    {
        switch (i)
        {
            case 1:
                {
                    i += RedSuraimuMarch(3.1f, 2.5f, 0f, 6); break;
                }
            case 2:
                {
                    i += RedSuraimuMarch(-3.1f, 3.6f, 180f, 6); break;
                }
            case 3:
                {
                    i += YellowSuraimu1(0f, 7.0f); 
            ...
            case 7:
                {
                    ...
                    if (this.delta1 > 2f)
                    {
                        i += BlueSuraimuHP1(-0.7f, 6.3f, 1f);
                    }
                    break;
                }
            case 8:
                {
                    i += BlueSuraimuEnergy1(0.7f, 6.3f);
                    NullDestroy(); 
                    break;
                }
    ...
    int case3()
    {
        switch (i)
        {
            case 1: 
                { 
                    i += RedSuraimuMarch(3.1f, 2.4f, 0f, 3); break;
                }
            case 2:
                {
                    i += RedSuraimuMarch(3.1f, 2.9f, 0f, 3); break;
                }
            case 3:
                {
                    i += RedSuraimuMarch(3.1f, 3.4f, 0f, 3); break;
                }
            case 4:
                {
                    i += RedSuraimuMarch(3.1f, 3.9f, 0f, 3); break;
                }
            case 5:
                {
                    this.delta1 += Time.deltaTime;
                    if (this.delta1 > 2f)
                    {
                        i += RedSuraimuMarch(-3.1f, 2.4f, 180f, 3);
                    }
                    break;
                }
            case 6:
                {
                    i += RedSuraimuMarch(-3.1f, 2.9f, 180f, 3); break;
                }
            case 7:
                {
                    i += RedSuraimuMarch(-3.1f, 3.4f, 180f, 3); break;
                }
            case 8:
                {
                    i += RedSuraimuMarch(-3.1f, 3.9f, 180f, 3); break;
                }
            case 9:
                {
                    i += YellowSuraimu1(0f, 7.0f); break;
                }
            case 10:
                {
                    this.delta1 += Time.deltaTime;
                    if (this.delta1 > 4f)
                    {
                        i += RedSuraimuMarch(-3.1f, 4.2f, 180f, 1);
                    }
                    break;
                }
            case 11:
                {
                    i += RedSuraimuMarch(3.1f, 3.6f, 0f, 1); break;
                }
            case 12:
                {
                    i += RedSuraimuMarch(-3.1f, 3.0f, 180f, 1); break;
                }
            case 13:
                {
                    i += RedSuraimuMarch(3.1f, 2.4f, 0f, 1); break;
                }
            case 14:
                {
                    i += RedSuraimuMarch(-3.1f, 1.8f, 180f, 1); break;
                }
            case 15:
                {
                    i += RedSuraimuMarch(3.1f, 1.2f, 0f, 1); break;
                }
            case 16:
                {
                    i += RedSuraimuMarch(-3.1f, 0.6f, 180f, 1); break;
                }
            case 17:
                {
                    i += RedSuraimuMarch(3.1f, 0.0f, 0f, 1);
                    break;
                }
            case 18:
                {
                    i += YellowSuraimuHP1(0f, 7.0f);
                    NullDestroy(); 
                    break;
                }
        }
    ...
    int case4()
    {
        switch (i)
        {
            case 1:
                {
                    i += BlueSuraimu1(-1.5f, 6.3f, 1f); break;
                }
            case 2:
                {
                    this.delta1 += Time.deltaTime;
            ...
            case 11:
                {
                    ...
                    if (this.delta1 > 6f)
                    {
                        i += BlueSuraimuHP1(0.5f, 7.3f, 1f);
                        BlueSuraimuEnergy1(-0.5f, 7.3f);
    ...
    int case5()
    {
        switch (i)
        {
            ...
            case 2:
                {
                    i += RedSuraimuMarch(-3.1f, 2.9f, 180f, 4); break;
                }
            case 3:
                {
                    i += RedSuraimuMarch(3.1f, 3.4f, 0f, 4); break;
                }
            case 4:
                {
                    this.delta1 += Time.deltaTime;
            ...
            case 5:
                {
                    ...
                    if (this.delta1 > 2f)
                    {
                        i += PurpleSuraimu1(1.0f, 7.8f);
                        PurpleSuraimu1(-1.0f, 7.8f);
                    }
                    break;
                }
            case 6:
                {
                    ...
                    if (this.delta1 > 2f)
                    {
                        i += PurpleSuraimu1(0f, 7.8f);
                        PurpleSuraimu1(1.5f, 7.0f);
                        PurpleSuraimu1(-1.5f, 7.0f);
                    }
                    break;
                }
            case 7:
                {
                    ...
                    {
                        i += PurpleSuraimu1(0f, 7.8f);
                        PurpleSuraimu1(0.8f, 7.0f);
                        PurpleSuraimu1(-0.8f, 7.0f);
                        PurpleSuraimu1(1.6f, 7.8f);
                        PurpleSuraimu1(-1.6f, 7.8f);
                    }
                    break;
                }
            case 8:
                {
                    ...
                    if (this.delta1 > 2.5f)
                    {
                        i += PurpleSuraimu1(0f, 6.0f);
                        PurpleSuraimu1(0.5f, 6.5f);
                        PurpleSuraimu1(-0.5f, 6.5f);
                        PurpleSuraimu1(1.0f, 7.0f);
                        PurpleSuraimu1(-1.0f, 7.0f);
                        BlueSuraimuHP1(0.4f, 7.3f, 1f);
                        BlueSuraimuHP1(-0.4f, 7.3f, -1f);
                    }
                    break;
                }
            case 9:
                {
                    ...
                    if (this.delta1 > 2.0f)
                    {
                        i += PurpleSuraimu1(0.8f, 7.8f);
                        PurpleSuraimu1(1.2f, 6.0f);
                        PurpleSuraimu1(-0.8f, 7.8f);
                        PurpleSuraimu1(-1.2f, 6.0f);
                        PurpleSuraimu1(1.6f, 7.8f);
                        PurpleSuraimu1(-1.6f, 7.8f);
                        NullDestroy();
    ...
    int TyuBossAdd()
    {
        ...
        go.transform.position = new Vector3(0, 7.94f, 0);
        return 1;
    }
}
